export namespace Flag {
  ...
  export const OPENCODE_EXPERIMENTAL_CHAT_MAX_RETRIES = number("OPENCODE_EXPERIMENTAL_CHAT_MAX_RETRIES")
  export const OPENCODE_EXPERIMENTAL_DISABLE_PASTE_SUMMARY = truthy("OPENCODE_EXPERIMENTAL_DISABLE_PASTE_SUMMARY")
  export const OPENCODE_EXPERIMENTAL_BATCH_TOOL = truthy("OPENCODE_EXPERIMENTAL_BATCH_TOOL")
  export const OPENCODE_EXPERIMENTAL_OPEN_TELEMETRY = truthy("OPENCODE_EXPERIMENTAL_OPEN_TELEMETRY")
  export const OPENCODE_EXPERIMENTAL_CONTINUE_LOOP_ON_DENY = truthy("OPENCODE_EXPERIMENTAL_CONTINUE_LOOP_ON_DENY")
  export const OPENCODE_EXPERIMENTAL_MCP_TIMEOUT = number("OPENCODE_EXPERIMENTAL_MCP_TIMEOUT")
